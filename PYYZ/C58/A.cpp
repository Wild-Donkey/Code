...
bitset<4000005> No;
unsigned a[4000005], b[4000005], Fac[4000005], Inv[4000005], Mu[4000005], f[4000005];
unsigned Pri[1000005], CntP(0);
unsigned A, B(0), D, t, m, n;
...
//  printf("Inv:"); for (unsigned i(1); i <= 100; ++i) printf("%u ", Inv[i]); putchar(0x0A);
  ...
  for (unsigned i(1), j; i <= n; ++i) {j = a[i] / B, b[j] = 1; if(j == 1) --m; }
  if(m ^ (n - 2)) ++m;
