...
signed main() {
  ...
  for (A = 1; A <= n; ++A) {
    ...
    for (unsigned k(0); k < Lim; ++k) {
      f[Nxt][1][1][Mo(k + a[A][0][0][0])] |= (((f[Now][0][0][k] << a[A][0][0][1]) | (f[Now][0][0][k] >> (Lim - a[A][0][0][1]))) & Meta);
      f[Nxt][1][0][Mo(k + a[A][1][0][0])] |= (((f[Now][0][0][k] << a[A][1][0][1]) | (f[Now][0][0][k] >> (Lim - a[A][1][0][1]))) & Meta);
      f[Nxt][0][1][Mo(k + a[A][2][1][0])] |= (((f[Now][0][0][k] << a[A][2][1][1]) | (f[Now][0][0][k] >> (Lim - a[A][2][1][1]))) & Meta);
    }
    for (unsigned j(1); j <= 100; ++j) {
      for (unsigned k(0); k < Lim; ++k) {
        f[Nxt][1][j + 1][Mo(k + a[A][0][0][0])] |= (((f[Now][0][j][k] << a[A][0][0][1]) | (f[Now][0][j][k] >> (Lim - a[A][0][0][1]))) & Meta);
        f[Nxt][1][j][Mo(k + a[A][1][0][0])] |= (((f[Now][0][j][k] << a[A][1][0][1]) | (f[Now][0][j][k] >> (Lim - a[A][1][0][1]))) & Meta);
        f[Nxt][0][j - 1][Mo(k + a[A][2][0][0])] |= (((f[Now][0][j][k] << a[A][2][0][1]) | (f[Now][0][j][k] >> (Lim - a[A][2][0][1]))) & Meta);
        f[Nxt][0][j + 1][Mo(k + a[A][2][1][0])] |= (((f[Now][0][j][k] << a[A][2][1][1]) | (f[Now][0][j][k] >> (Lim - a[A][2][1][1]))) & Meta);
      }
    }
    for (unsigned i(1); i <= 100; ++i) {
      for (unsigned k(0); k < Lim; ++k) {
        f[Nxt][i + 1][1][Mo(k + a[A][0][0][0])] |= (((f[Now][i][0][k] << a[A][0][0][1]) | (f[Now][i][0][k] >> (Lim - a[A][0][0][1]))) & Meta);
        f[Nxt][i + 1][0][Mo(k + a[A][1][0][0])] |= (((f[Now][i][0][k] << a[A][1][0][1]) | (f[Now][i][0][k] >> (Lim - a[A][1][0][1]))) & Meta);
        f[Nxt][i - 1][0][Mo(k + a[A][1][1][0])] |= (((f[Now][i][0][k] << a[A][1][1][1]) | (f[Now][i][0][k] >> (Lim - a[A][1][1][1]))) & Meta);
        f[Nxt][i][1][Mo(k + a[A][2][1][0])] |= (((f[Now][i][0][k] << a[A][2][1][1]) | (f[Now][i][0][k] >> (Lim - a[A][2][1][1]))) & Meta);
      }
      for (unsigned j(1); j <= 100; ++j) {
        for (unsigned k(0); k < Lim; ++k) {
